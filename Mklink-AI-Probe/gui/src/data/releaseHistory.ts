...
export const releaseHistory: ReleaseHistoryEntry[] = [
  {
    ...
    changes: [
      ...
      '为已验证的 STM32 F1、F4、G4、H7 增加安全的可逆加锁与解锁，其他器件保持置灰。',
    ],
    changesEn: [
      ...
      'Add safe reversible locking and unlocking for validated STM32 F1, F4, G4, and H7 devices; other targets remain disabled.',
    ],
  },
  {
    version: '0.1.9',
