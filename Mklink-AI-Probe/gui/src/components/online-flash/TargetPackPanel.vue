...
const emit = defineEmits<{ search: [value: string]; select: [target: TargetRecord]; updateIndex: []; cancel: []; addAlgorithm: [file: File]; removeAlgorithm: [algorithmId: string] }>()
const query = ref('')
